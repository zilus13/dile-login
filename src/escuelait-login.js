...
export class EscuelaItLogin extends LitElement {
        ...
        return html`
            <div class="login-box">
                ...
                <form>
                    ...
                    <input type="submit" value="Log In" @click="${this.login}" @keypress="${this.login}" />
                </form>
            </div>
            ${this.invalido
...
customElements.define('escuelait-login', EscuelaItLogin);
